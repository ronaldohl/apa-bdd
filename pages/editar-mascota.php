...
<div class="container m-5">
    <div class="row">
        <div class="col">
            <h2><i class="fa fa-paw mr-3"></i>Ver Mascota</h2>
        </div>
    ...
    <form action="editar-mascota.php" method="POST">
        ...
        <div class="form-row justify-content-center">
            <div class="input-group mb-2 text-center col-11">
                ...
                <input  type="text" name="fecha_desparasitacion" class="form-control" id="inlineFormInputGroup"
        ...
        <div class="form-row justify-content-center">
            <div class="input-group mb-2 text-center col-11">
                ...
                <input  type="text" name="fecha_esterilizacion" class="form-control" id="inlineFormInputGroup"
        ...
        <div class="form-row">
            <div class="col">
                <div class="text-right mr-4">
                    <a href="/amigosproanimal/pages/mascotas.php" class="mt-2 btn btn-danger ml-5" >
                    <i class="fa fa-arrow-circle-o-left mr-2"></i>Regresar 
                    </a>
                </div>
            </div>
        </div>
