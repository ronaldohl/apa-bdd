...
$datos_rescatista = getPersona($datos_rescate['id_persona']);
    ...
    <div class="form-group mt-3 mb-3">
                    ...
                    <div class="form-row  justify-content-center">
                        <div class="input-group mb-2 text-center col-11">
                            ...
                            <input readonly type="date"  name="fecha_rescate" class="form-control " placeholder="Fecha Rescate" required aria-required="true" required="required" data-validation-required-message="Fecha Inválida." value="<?php echo $datos_rescate['fecha_rescate']; ?>">        
                        </div>
                    </div>
                    ...
                    <label class="form-label mt-2">Nombre de la calle:</label>
                            <div class="form-row  justify-content-center">
                                <div class="input-group mb-2 text-center col-11">
                                    ...
                                    <input readonly type="text" name="calle" class="form-control " placeholder="<?php echo $datos_domicilio['calle']; ?>" required aria-required="true" pattern="[A-Za-z ]{1,100}" title="Sólo letras Máximo 100" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-row  justify-content-center">
                                <div class="input-group mb-2 text-center col-11">
                                    ...
                                    <input readonly type="text" name="colonia" class="form-control" id="inlineFormInputGroup" placeholder="<?php echo $datos_domicilio['colonia']; ?>" required="required" data-validation-required-message="" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-row  justify-content-center">
                                <div class="input-group mb-2 text-center col-5">
                                    ...
                                    <input readonly type="text" readonly  name="nombre" class="form-control" id="inlineFormInputGroup" placeholder="<?php echo $datos_mascota['nombre']; ?>" required="required" data-validation-required-message="Por favor ingresa el nombre de la mascota">
                                </div>
                                <div class="input-group mb-2 text-center col-4 ">
                                    <div class="input-group-addon">
                                        <div class="input-group-text"><i class="fa fa-bug"></i></div>
                                    </div>
                                    <input readonly type="text" readonly name="especie" class="form-control" id="inlineFormInputGroup" placeholder="<?php echo $datos_mascota['especie']; ?>" required="required" data-validation-required-message="Por favor ingresa el nombre de la mascota">
                                </div>
                                <div class="col-3">
